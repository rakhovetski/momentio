...
SECRET_KEY = 'django-insecure-5xxyqhry(azapccz73^mjz$5m=)s$su3!l=lzg-6f40_f^k++q'
...
DJOSER = {
    ...
    "SERIALIZERS": {
        ...
        "user_list": "account.serializers.CustomUserCreateSerializer",
    ...
    'ACTIVATION_URL': '#/actiation/{uid}/{token}',
